...
define(["require", "exports", 'react', '../../../../index', '../../../../components/pickers/BasePicker', './Picker.CustomResult.Example.scss'], function (require, exports, React, index_1, BasePicker_1) {
    "use strict";
    var data = [
        {
                ...
                React.createElement("div", {ref: this._resolveRef('root'), className: 'ms-BasePicker', onKeyDown: this.onKeyDown}, 
                    React.createElement(index_1.SelectionZone, {selection: this.selection}, 
                        React.createElement("div", {className: 'ms-BasePicker-text'}, 
                            React.createElement(index_1.BaseAutoFill, {className: 'ms-BasePicker-input', ref: this._resolveRef('input'), onFocus: this.onInputFocus, onInputValueChange: this.onInputChange, suggestedDisplayValue: suggestedDisplayValue, "aria-activedescendant": 'sug-' + this.suggestionStore.currentIndex, "aria-owns": 'suggestion-list', "aria-expanded": 'true', "aria-haspopup": 'true', autoCapitalize: 'off', autoComplete: 'off'})
                        )
                    )
                ), 
