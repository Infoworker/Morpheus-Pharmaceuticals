    ...
    var ContextualMenuCheckmarksExample = (function (_super) {
        ...
        ContextualMenuCheckmarksExample.prototype.render = function () {
            ...
            return (React.createElement("div", null, 
                ...
                this.state.isContextMenuVisible ? (React.createElement(index_1.ContextualMenu, {targetPoint: this.state.target, useTargetPoint: true, shouldFocusOnMount: false, onDismiss: this._onDismiss, directionalHint: index_1.DirectionalHint.bottomLeftEdge, items: [
                    {
                        key: keys[0],
                        name: 'New',
                        canCheck: true,
