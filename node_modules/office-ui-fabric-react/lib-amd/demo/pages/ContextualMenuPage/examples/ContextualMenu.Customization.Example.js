...
define(["require", "exports", 'react', '../../../../utilities/css', '../../../../index', './ContextualMenuExample.scss'], function (require, exports, React, css_1, index_1) {
    "use strict";
    var ContextualMenuCustomizationExample = (function (_super) {
        ...
        ContextualMenuCustomizationExample.prototype.render = function () {
            return (React.createElement("div", null, 
                React.createElement(index_1.Button, {onClick: this._onClick}, " Click for ContextualMenu "), 
                this.state.isContextMenuVisible ? (React.createElement(index_1.ContextualMenu, {targetPoint: this.state.target, useTargetPoint: true, shouldFocusOnMount: false, onDismiss: this._onDismiss, directionalHint: index_1.DirectionalHint.bottomLeftEdge, className: 'ms-ContextualMenu-customizationExample', items: [
                    {
                        key: 'newItem',
                        icon: 'Add',
                        items: [
