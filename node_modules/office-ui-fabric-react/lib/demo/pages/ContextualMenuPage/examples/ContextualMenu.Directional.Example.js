...
var ContextualMenuDirectionalExample = (function (_super) {
    ...
    ContextualMenuDirectionalExample.prototype.render = function () {
        ...
        return (React.createElement("div", {className: 'ms-ContextualMenuDirectionalExample'}, 
            ...
            isContextualMenuVisible ? (React.createElement(index_1.ContextualMenu, {targetElement: this.refs.menuButton, isBeakVisible: isBeakVisible, directionalHint: directionalHint, gapSpace: gapSpace, beakWidth: beakWidth, items: [
                {
                    key: 'newItem',
                    name: 'New',
                    icon: 'Add',
